    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe(Context context) {
            context.getContentResolver().registerContentObserver(
                    Settings.Secure.getUriFor(Settings.Secure.LOCK_SCREEN_BLUR_ENABLED),
                    false, this);
            onChange(true);
        }
        ...
        public void onChange(boolean selfChange) {
            mKeyguardBlurEnabled = Settings.Secure.getInt(mContext.getContentResolver(),
                    Settings.Secure.LOCK_SCREEN_BLUR_ENABLED, 0) == 1;
        }
    }
}
